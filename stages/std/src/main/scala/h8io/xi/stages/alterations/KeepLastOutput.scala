...
object KeepLastOutput {
  private[alterations] final case class None[-I, +O, +E](underlying: Stage[I, O, E]) extends Decorator[I, O, E] {
  ...
  private[alterations] final case class Some[-I, +O, +E](out: O, underlying: Stage[I, O, E])
